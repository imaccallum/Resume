...
class CollectionViewController: UICollectionViewController {
    let pages = ["Home", "Education", "Bio", "Apps", "Stack", "Github", "Contact"]
    var menu: Menu!
...
//        guard let collectionView = collectionView, indexPath = collectionView.indexPathForItemAtPoint(collectionView.contentOffset + collectionView.frame.size.half()) else { return }
