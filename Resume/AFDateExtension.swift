    ...
    convenience init(fromString string: String, format:DateFormat)
    {
        ...
        switch format {
            ...
            case .ISO8601:
                ...
                let formatter = NSDate.formatter(ISO8601Format)
            ...
            case .RSS:
                ...
                let formatter = NSDate.formatter(RSSFormat)
                if let date = formatter.dateFromString(string as String) {
                    self.init(timeInterval:0, sinceDate:date)
                } else {
                    self.init()
            ...
            case .AltRSS:
                ...
                let formatter = NSDate.formatter(AltRSSFormat)
                if let date = formatter.dateFromString(string as String) {
                    self.init(timeInterval:0, sinceDate:date)
                } else {
                    self.init()
            ...
            case .Custom(let dateFormat):
                ...
                let formatter = NSDate.formatter(dateFormat)
                if let date = formatter.dateFromString(string as String) {
                    self.init(timeInterval:0, sinceDate:date)
                } else {
                    self.init()
